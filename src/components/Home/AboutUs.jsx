...
import aboutImg1 from "../../../public/png/about1.png";
import aboutImg2 from "../../../public/png/about2.png";
import aboutImg3 from "../../../public/png/about3.png";

const AboutUs = () => {
  return (
    <section
      id="about"
      className="bg-[#F0F0F5] py-10 md:py-20 px-4 md:px-16 max-w-screen mx-auto"
    >
        ...
        <div className="flex flex-col gap-6 h-full md:col-span-1">
          ...
          <div className="bg-white rounded-xl py-4 md:py-6 flex flex-col justify-start relative flex-1">
            ...
            <p className="text-gray-600 px-4 md:px-6 text-base md:text-lg mt-2 md:mt-0">
              Helping children and adults receive accurate autism and ADHD
              evaluations.
            </p>
            ...
            <p className="text-gray-600 px-4 md:px-6 text-base md:text-lg mt-2 md:mt-0">
              Introducing Neurocheckpro as a trusted platform for neurological
              assessment.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#FFE2F7] rounded-xl py-4 md:py-6 px-4 md:px-6 flex flex-col md:col-span-2 lg:col-span-2 gap-4 md:gap-8 h-full">
          ...
          <div className="px-1 md:px-2 flex flex-col gap-4 md:gap-8">
            <p className="text-gray-700 text-base md:text-lg">
              Neurocheckpro provides reliable and clinically validated tools to
              assess autism and ADHD in both children and adults. Our platform
              makes it easy for families and professionals to understand
              neurological development quickly and accurately.
            </p>
            <p className="text-gray-700 text-base md:text-lg">
              We offer specialized assessments for individual conditions or
              combined evaluations, delivering clear, actionable insights. Our
              goal is to support early detection, informed decision-making, and
              better care for every user.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-6 h-full md:col-span-1">
          ...
          <div className="bg-white rounded-xl p-4 md:p-6 flex flex-col gap-2 relative flex-1">
            ...
            <p className="text-gray-600 text-base md:text-lg">
              Our mission is to make neurological assessments accessible,
              accurate, and easy to use for everyone. We aim to empower
              families, individuals, and clinicians with trusted insights that
              support early detection, informed decisions, and better care for
              autism and ADHD.
            </p>
          </div>
        </div>
